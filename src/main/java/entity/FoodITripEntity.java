 ...
 */
@Entity
@Table(name = "food_i_trip", schema = "", catalog = "projectdb")
@NamedQueries(value = {@NamedQuery(name = "showFood", query = "select f from FoodITripEntity f"),
        @NamedQuery(name = "findFood",query = "select f from FoodITripEntity f where f.name like :foodName")})
public class FoodITripEntity {
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        FoodITripEntity that = (FoodITripEntity) o;
