	...
	d.AmChart = d.Class({
		...
		measure: function() {
			...
			if (a) {
				...
				e = a.style;
				a = e.width;
				e = e.height; - 1 != a.indexOf("px") && (c = d.removePx(a)); - 1 != e.indexOf("px") && (g = d.removePx(e));
				g = Math.round(g);
				c = Math.round(c);
...
(function() {
	...
	d.AmLegend = d.Class({
		construct: function(a) {
			...
			this.spacing = 10;
			this.markerDisabledColor = "#bec676";
			this.markerType =
				"square";
			this.markerSize = 16;
				...
				if (!isNaN(k)) {
					...
					if (!isNaN(p)) {
						var z = 5 * Math.abs(p - k) / l,
							...
							C = (b.zoomX() - C * w) * (l / h) +
							C * w,
							p = (b.zoomY() - p * z) * (l / h) + p * z;.1 < Math.abs(l - h) && (b.zoomTo(l, C, p, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
					}
...
(function() {
	...
	d.ZoomControl = d.Class({
		construct: function(a) {
			...
			this.buttonRollOverColor = "#bec676";
			this.buttonFillColor = "#bec676";
